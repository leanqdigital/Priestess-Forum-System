class PostModalManager {
  ...
  <div class="flex items-center justify-between ${post.post_image ? `hidden` : ""}">
    <h2 class="text-white">Post Details</h2>
      ...
      <div class="flex items-start gap-3 max-[1100px]:flex-col">
       ${post.post_image
        ...
        <article class="flex-1 flex flex-col gap-3 w-full post bg-primary-100 rounded-lg shadow-sm  max-[500px]:mb-[150px] ${post.post_image
        ? `min-[500px]:p-4`
        : ""
      }">
                <div class="flex items-center justify-between ${post.post_image ? `` : "hidden"}">
