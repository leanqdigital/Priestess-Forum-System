class PostModalManager {
  static async open(post) {
    ...
    console.log("This post is voted", voteData);
    let imageData = null,
      audioData = null,
      videoData = null;
...
<div
    class="flex ${containerClass} h-[700px] max-[1300px]:w-[900px] max-[1300px]:h-[600px] max-[900px]:w-screen max-[900px]:h-screen">
                ...
                <div class="
                    ...
                    <div class="flex items-center justify-between w-full">
                        ...
                        <button id="submit-comment"
                            ...
                            <span class="max-[500px]:hidden o3 page-text">Comment</span>
