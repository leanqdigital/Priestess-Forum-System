    ...
    <div class="flex flex-col gap-4 flex-1 post-details-modal overflow-y-auto overflow-x-hidden">
                ...
                <div class="post-audio-wrapper w-full">
                    <div class="audio-player-modal p-5 rounded-[12px] w-full text-center" id="audio-${post.id}"
                        ...
                        <div class="controls flex justify-center gap-[15px] my-[15px]">
                            ...
                            <div class="cursor-pointer play-pause" data-audio-button="${post.id}"
                        ...
                        <div class="progress-container flex items-center gap-[10px]">
                            ...
                            <input class="flex-grow-1 appearance-none bg-grey-200 h-[3px] w-full progress" type="range"
        ...
        <div class="flex gap-2 sticky bottom-0 bg-white w-full px-4 py-2 border-t-[1px] border-secondary-300">
            ...
            <div class="
                ...
                <div class="emojiButton cursor-pointer absolute right-[2rem] w-max hideTypeField">😀</div>
                <div class="flex justify-between p-4 bg-white rounded-lg shadow-md hidden emojisWrapper hideTypeField">
                ...
                <div class="flex items-center justify-between w-full">
                    <div class="flex items-center gap-2">
                        ...
                        <button id="upload-video-button-comment" class="icon-button hideTypeField" type="button">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
