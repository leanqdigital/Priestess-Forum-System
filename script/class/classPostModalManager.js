...
<div class="flex w-[1250px] h-[700px] max-[1300px]:w-[900px] max-[1300px]:h-[600px] max-[900px]:w-screen max-[900px]:h-screen">
    ...
    ${post.file_tpe === "Image" && imageData? `
      <div class="w-full h-full border-r-[10px] border-[#000000] flex-1 max-[900px]:hidden">
        ...
        <div class="flex flex-col gap-3 flex-1 w-full h-full">
            ${imageData ? `<img class="w-full h-full object-cover" src="${imageData.link}" alt="Post Image">`: ""}
        </div>
        `: ""}
    </div>
    `:``}
    ${post.file_tpe === "Video" && videoData? `
      <div class="w-full h-full border-r-[10px] border-[#000000] flex-1 max-[900px]:hidden">
        ${videoData ? `
        <div class="flex flex-col gap-3 flex-1 w-full h-full">
            ${videoData ? `<video controls width="100%" class="object-cover"><source src="${videoData.link}" type="${videoData.type}"></video>`: ""}
        </div>
        `: ""}
    </div>
    `:``}
    ...
    <div class="flex flex-col gap-4 flex-1 bg-primary-100 overflow-auto relative">
          ...
          <div class = "flex flex-col gap-4 px-6">
            <div class="flex items-center">
                <div class="flex items-center gap-2">
                    <div class="author-image-container">
                        <img class = "w-[32px] h-[32px] rounded-full" src="${post.author.profileImage}">
                    </div>
                    <div class="author-name-container">
                        <div class="text-center text-white text-base font-semibold font-['Avenir LT Std'] leading-normal">${post.author.name}</div>
                    </div>
                    <div class="h-[15px] w-[2px] bg-[#c29d68]"></div>
                    <div class="text-center text-white text-xs font-['Avenir LT Std'] leading-3">${post.date}
                    </div>
                </div>
            </div>
            <div class="flex">
                <div class="post-content w-[90%]">
                    <div class="text-white text-base font-['Avenir LT Std'] leading-tight">${post.content}.</div>
                </div>
            ...
            <div class="flex gap-2">
                <div class="author-image-container max-[900px]:hidden"><img class = "w-[32px] h-[32px] rounded-full" src="${post.author.profileImage}"></div>
