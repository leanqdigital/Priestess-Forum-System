      ...
      const query = `
            query calcRegisteredMembersRegisteredCoursesMany(
              ...
              calcRegisteredMembersRegisteredCoursesMany(
                ...
                orderBy: [
                  {
                    path: ["Registered_Member", "display_name"]
                    type: asc
                  }
                ]
              ) {
                Registered_Member_Contact_ID: field(
                  arg: ["Registered_Member", "id"]
                )
                Registered_Member_First_Name: field(
                  arg: ["Registered_Member", "first_name"]
                )
                Registered_Member_Last_Name: field(
                  arg: ["Registered_Member", "last_name"]
                )
                Registered_Member_Profile_Image: field(
                  arg: ["Registered_Member", "profile_image"]
                )
                Registered_Member_Display_Name: field(
                  arg: ["Registered_Member", "display_name"]
                )
                Registered_Member_Forum_Image: field(
                  arg: ["Registered_Member", "forum_image"]
                )
              }
            }
      `;
